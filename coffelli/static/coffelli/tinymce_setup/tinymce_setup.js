...
tinyMCE.init({
    ...
    plugins: 'advimage,advlink,fullscreen,paste,media,searchreplace,coffelli,template',
    // directionality : "rtl",
    ...
    theme_advanced_buttons1: 'formatselect,styleselect,|,bold,italic,underline,|,bullist,numlist,blockquote,|,justifyleft,justifycenter,justifyright,justifyfull,|,undo,redo,|,link,unlink,|,image,|,fullscreen,|,coffelli_adv',
    theme_advanced_buttons2: 'search,|,pasteword,template,media,charmap,|,code,|,table,cleanup,coffelli_documentstructure',
    ...
    // Grappelli Settings
    coffelli_adv_hidden: false,
    coffelli_show_documentstructure: 'on'
