...
(function($){
            ...
            .autocomplete({
                ...
                source: function(request, response) {
                    $.ajax({
                        ...
                        dataType: 'json',
                        data: "term=" + encodeURIComponent(request.term) + "&app_label=" + coffelli.get_app_label(elem) + "&model_name=" + coffelli.get_model_name(elem) + "&query_string=" + coffelli.get_query_string(elem),
    ...
    var lookup_id = function(elem, options) {
        $.getJSON(options.lookup_url, {
            object_id: elem.val(),
            app_label: coffelli.get_app_label(elem),
            model_name: coffelli.get_model_name(elem)
        }, function(data) {
