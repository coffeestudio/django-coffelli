(function() {
    ...
    tinymce.PluginManager.requireLangPack('coffelli_contextmenu');
    ...
    tinymce.create('tinymce.plugins.ContextMenu', {
        ...
        _getMenu : function(ed) {
            ...
            title_b_before = 'coffelli_contextmenu.' + title_prefix + '_coffelli_contextmenu_insertpbefore_desc';
            title_b_after = 'coffelli_contextmenu.' + title_prefix + '_coffelli_contextmenu_insertpafter_desc';
            title_b_before_root = 'coffelli_contextmenu.' + title_prefix + '_coffelli_contextmenu_insertpbeforeroot_desc';
            title_b_after_root = 'coffelli_contextmenu.' + title_prefix + '_coffelli_contextmenu_insertpafterroot_desc';
            title_b_delete = 'coffelli_contextmenu.' + title_prefix + '_coffelli_contextmenu_delete_desc';
            title_b_delete_root = 'coffelli_contextmenu.' + title_prefix + '_coffelli_contextmenu_deleteroot_desc';
            title_b_moveup = 'coffelli_contextmenu.' + title_prefix + '_coffelli_contextmenu_moveup_desc';
            title_b_moveup_root = 'coffelli_contextmenu.' + title_prefix + '_coffelli_contextmenu_moveuproot_desc';
    ...
    // Register plugin
    tinymce.PluginManager.add('coffelli_contextmenu', tinymce.plugins.ContextMenu);
})();